    ...
    return (
        qns.length !== 0
            ? <Card
                ...
                <CardHeader
                    title={'Question ' + (qnIndex + 1) + ' of 15'}
                    action={<Typography>{getFormatedTime(timeTaken)}</Typography>} />
                <Box>
                    <LinearProgress variant="determinate" value={(qnIndex + 1) * 100 / 15} />
                </Box>
                {qns[qnIndex].imageName != null
                    ? <CardMedia
                        ...
                        sx={{  width:
                            qns[qnIndex].imageName === 'level1.png' ? '200px' :
                            qns[qnIndex].imageName === 'level2.png' ? '120px' :
                            qns[qnIndex].imageName === 'level3.png' ? '160px' :
                            '100px', m: qns[qnIndex].imageName === 'level1.png' ? '5px auto' : '40px auto'  }}/>
                    : null}
                <CardContent>
